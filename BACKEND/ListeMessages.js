...
export const ListeMessagesEmis = [
    ...
    "create_user_request", // { login: string, password: string, firstname: string, lastname: string, phone: string, job: string, desc: string }=
...
export const ListeMessagesRecus = [
    ...
    "create_user_response", // { etat: boolean, error?: string, userId?: string }
