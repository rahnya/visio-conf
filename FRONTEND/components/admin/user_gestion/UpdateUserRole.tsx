...
export default function UpdateUserRole ({
    ...
    useEffect(() => {
        if(user){
            ...
            setJob(user.job);
            setDesc(user.desc);
            setSelectedRoles(user.roles?.map((r:any) => r._id || r) || []);
        }
    }, [user])
        ...
        <div className={styles.container}>
            ...
            <div className={styles.signupForm}>
                ...
                <div className={styles.formGroupRow}>
                    ...
                    <div className={styles.formGroup}>
                        <label htmlFor="password">Mot de passe : <span style={{fontWeight: 400, fontSize: "0.85em", color: "gray"}}>(laisser vide pour ne pas changer)</span></label>
                        <input
                            type="password"
                            id="password"
                            value={password}
